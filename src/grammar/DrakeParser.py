...
class DrakeParser ( Parser ):
    ...
    def single_input(self):
        ...
        try:
            ...
            if token in [DrakeParser.NEWLINE]:
                ...
                pass
            elif token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.RETURN, DrakeParser.RAISE, DrakeParser.FROM, DrakeParser.IMPORT, DrakeParser.GLOBAL, DrakeParser.NONLOCAL, DrakeParser.ASSERT, DrakeParser.LAMBDA, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.YIELD, DrakeParser.DEL, DrakeParser.PASS, DrakeParser.CONTINUE, DrakeParser.BREAK, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.STAR, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
    ...
    def file_input(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << DrakeParser.STRING) | (1 << DrakeParser.NUMBER) | (1 << DrakeParser.DEF) | (1 << DrakeParser.RETURN) | (1 << DrakeParser.RAISE) | (1 << DrakeParser.FROM) | (1 << DrakeParser.IMPORT) | (1 << DrakeParser.GLOBAL) | (1 << DrakeParser.NONLOCAL) | (1 << DrakeParser.ASSERT) | (1 << DrakeParser.IF) | (1 << DrakeParser.WHILE) | (1 << DrakeParser.FOR) | (1 << DrakeParser.TRY) | (1 << DrakeParser.WITH) | (1 << DrakeParser.LAMBDA) | (1 << DrakeParser.NOT) | (1 << DrakeParser.NONE) | (1 << DrakeParser.TRUE) | (1 << DrakeParser.FALSE) | (1 << DrakeParser.CLASS) | (1 << DrakeParser.YIELD) | (1 << DrakeParser.DEL) | (1 << DrakeParser.PASS) | (1 << DrakeParser.CONTINUE) | (1 << DrakeParser.BREAK) | (1 << DrakeParser.ASYNC) | (1 << DrakeParser.AWAIT) | (1 << DrakeParser.NEWLINE) | (1 << DrakeParser.NAME) | (1 << DrakeParser.ELLIPSIS) | (1 << DrakeParser.STAR) | (1 << DrakeParser.OPEN_PAREN) | (1 << DrakeParser.OPEN_BRACK))) != 0) or ((((_la - 66)) & ~0x3f) == 0 and ((1 << (_la - 66)) & ((1 << (DrakeParser.ADD - 66)) | (1 << (DrakeParser.MINUS - 66)) | (1 << (DrakeParser.NOT_OP - 66)) | (1 << (DrakeParser.OPEN_BRACE - 66)) | (1 << (DrakeParser.AT - 66)))) != 0):
                self.state = 181
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [DrakeParser.NEWLINE]:
                    ...
                    self.match(DrakeParser.NEWLINE)
                    pass
                elif token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.DEF, DrakeParser.RETURN, DrakeParser.RAISE, DrakeParser.FROM, DrakeParser.IMPORT, DrakeParser.GLOBAL, DrakeParser.NONLOCAL, DrakeParser.ASSERT, DrakeParser.IF, DrakeParser.WHILE, DrakeParser.FOR, DrakeParser.TRY, DrakeParser.WITH, DrakeParser.LAMBDA, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.CLASS, DrakeParser.YIELD, DrakeParser.DEL, DrakeParser.PASS, DrakeParser.CONTINUE, DrakeParser.BREAK, DrakeParser.ASYNC, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.STAR, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE, DrakeParser.AT]:
                    self.state = 180
                    self.stmt()
                    pass
                else:
    ...
    def decorator(self):
        ...
        try:
            ...
            if _la==DrakeParser.OPEN_PAREN:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << DrakeParser.STRING) | (1 << DrakeParser.NUMBER) | (1 << DrakeParser.LAMBDA) | (1 << DrakeParser.NOT) | (1 << DrakeParser.NONE) | (1 << DrakeParser.TRUE) | (1 << DrakeParser.FALSE) | (1 << DrakeParser.AWAIT) | (1 << DrakeParser.NAME) | (1 << DrakeParser.ELLIPSIS) | (1 << DrakeParser.STAR) | (1 << DrakeParser.OPEN_PAREN) | (1 << DrakeParser.POWER) | (1 << DrakeParser.OPEN_BRACK))) != 0) or ((((_la - 66)) & ~0x3f) == 0 and ((1 << (_la - 66)) & ((1 << (DrakeParser.ADD - 66)) | (1 << (DrakeParser.MINUS - 66)) | (1 << (DrakeParser.NOT_OP - 66)) | (1 << (DrakeParser.OPEN_BRACE - 66)))) != 0):
                    self.state = 200
                    self.arglist()
    ...
    def stmt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.RETURN, DrakeParser.RAISE, DrakeParser.FROM, DrakeParser.IMPORT, DrakeParser.GLOBAL, DrakeParser.NONLOCAL, DrakeParser.ASSERT, DrakeParser.LAMBDA, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.YIELD, DrakeParser.DEL, DrakeParser.PASS, DrakeParser.CONTINUE, DrakeParser.BREAK, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.STAR, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                self.enterOuterAlt(localctx, 1)
                self.state = 411
                self.simple_stmt()
                pass
    ...
    def small_stmt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.LAMBDA, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.STAR, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                self.state = 428
                self.expr_stmt()
                pass
    ...
    class Expr_stmtContext(ParserRuleContext):
        ...
        def yield_expr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DrakeParser.Yield_exprContext)
            else:
                return self.getTypedRuleContext(DrakeParser.Yield_exprContext,i)
    ...
    def expr_stmt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [DrakeParser.COLON]:
                self.state = 439
                self.annassign()
                pass
            elif token in [DrakeParser.ADD_ASSIGN, DrakeParser.SUB_ASSIGN, DrakeParser.MULT_ASSIGN, DrakeParser.AT_ASSIGN, DrakeParser.DIV_ASSIGN, DrakeParser.MOD_ASSIGN, DrakeParser.AND_ASSIGN, DrakeParser.OR_ASSIGN, DrakeParser.XOR_ASSIGN, DrakeParser.LEFT_SHIFT_ASSIGN, DrakeParser.RIGHT_SHIFT_ASSIGN, DrakeParser.POWER_ASSIGN, DrakeParser.IDIV_ASSIGN]:
                self.state = 440
                self.augassign()
                self.state = 443
                self._errHandler.sync(self)
                ...
                if token in [DrakeParser.YIELD]:
                    ...
                    self.yield_expr()
                    pass
                elif token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.LAMBDA, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                    self.state = 442
                    self.testlist()
                    pass
                else:
                ...
                pass
            elif token in [DrakeParser.NEWLINE, DrakeParser.SEMI_COLON, DrakeParser.ASSIGN]:
                self.state = 452
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==DrakeParser.ASSIGN:
                    self.state = 445
                    self.match(DrakeParser.ASSIGN)
                    self.state = 448
                    self._errHandler.sync(self)
    ...
    def return_stmt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << DrakeParser.STRING) | (1 << DrakeParser.NUMBER) | (1 << DrakeParser.LAMBDA) | (1 << DrakeParser.NOT) | (1 << DrakeParser.NONE) | (1 << DrakeParser.TRUE) | (1 << DrakeParser.FALSE) | (1 << DrakeParser.AWAIT) | (1 << DrakeParser.NAME) | (1 << DrakeParser.ELLIPSIS) | (1 << DrakeParser.OPEN_PAREN) | (1 << DrakeParser.OPEN_BRACK))) != 0) or ((((_la - 66)) & ~0x3f) == 0 and ((1 << (_la - 66)) & ((1 << (DrakeParser.ADD - 66)) | (1 << (DrakeParser.MINUS - 66)) | (1 << (DrakeParser.NOT_OP - 66)) | (1 << (DrakeParser.OPEN_BRACE - 66)))) != 0):
                self.state = 499
                self.testlist()
        ...
        try:
            ...
            if token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.RETURN, DrakeParser.RAISE, DrakeParser.FROM, DrakeParser.IMPORT, DrakeParser.GLOBAL, DrakeParser.NONLOCAL, DrakeParser.ASSERT, DrakeParser.LAMBDA, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.YIELD, DrakeParser.DEL, DrakeParser.PASS, DrakeParser.CONTINUE, DrakeParser.BREAK, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.STAR, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                ...
                while True:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << DrakeParser.STRING) | (1 << DrakeParser.NUMBER) | (1 << DrakeParser.DEF) | (1 << DrakeParser.RETURN) | (1 << DrakeParser.RAISE) | (1 << DrakeParser.FROM) | (1 << DrakeParser.IMPORT) | (1 << DrakeParser.GLOBAL) | (1 << DrakeParser.NONLOCAL) | (1 << DrakeParser.ASSERT) | (1 << DrakeParser.IF) | (1 << DrakeParser.WHILE) | (1 << DrakeParser.FOR) | (1 << DrakeParser.TRY) | (1 << DrakeParser.WITH) | (1 << DrakeParser.LAMBDA) | (1 << DrakeParser.NOT) | (1 << DrakeParser.NONE) | (1 << DrakeParser.TRUE) | (1 << DrakeParser.FALSE) | (1 << DrakeParser.CLASS) | (1 << DrakeParser.YIELD) | (1 << DrakeParser.DEL) | (1 << DrakeParser.PASS) | (1 << DrakeParser.CONTINUE) | (1 << DrakeParser.BREAK) | (1 << DrakeParser.ASYNC) | (1 << DrakeParser.AWAIT) | (1 << DrakeParser.NAME) | (1 << DrakeParser.ELLIPSIS) | (1 << DrakeParser.STAR) | (1 << DrakeParser.OPEN_PAREN) | (1 << DrakeParser.OPEN_BRACK))) != 0) or ((((_la - 66)) & ~0x3f) == 0 and ((1 << (_la - 66)) & ((1 << (DrakeParser.ADD - 66)) | (1 << (DrakeParser.MINUS - 66)) | (1 << (DrakeParser.NOT_OP - 66)) | (1 << (DrakeParser.OPEN_BRACE - 66)) | (1 << (DrakeParser.AT - 66)))) != 0)):
                        break
    ...
    def test(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.NOT, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                self.enterOuterAlt(localctx, 1)
                self.state = 723
                self.or_test()
                self.state = 729
    ...
    def not_test(self):
        ...
        try:
            ...
            if token in [DrakeParser.NOT]:
                ...
                self.not_test()
                pass
            elif token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                self.enterOuterAlt(localctx, 2)
                self.state = 770
                self.comparison()
                pass
    ...
    class ComparisonContext(ParserRuleContext):
        ...
        def comp_op(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DrakeParser.Comp_opContext)
            else:
                return self.getTypedRuleContext(DrakeParser.Comp_opContext,i)
    ...
    def comparison(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((((_la - 18)) & ~0x3f) == 0 and ((1 << (_la - 18)) & ((1 << (DrakeParser.IN - 18)) | (1 << (DrakeParser.NOT - 18)) | (1 << (DrakeParser.IS - 18)) | (1 << (DrakeParser.LESS_THAN - 18)) | (1 << (DrakeParser.GREATER_THAN - 18)) | (1 << (DrakeParser.EQUALS - 18)) | (1 << (DrakeParser.GT_EQ - 18)) | (1 << (DrakeParser.LT_EQ - 18)) | (1 << (DrakeParser.NOT_EQ_1 - 18)) | (1 << (DrakeParser.NOT_EQ_2 - 18)))) != 0):
                self.state = 774
                self.comp_op()
                self.state = 775
                self.expr()
    ...
    def comp_op(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 3)
                self.state = 784
                self.match(DrakeParser.EQUALS)
                pass

            elif la_ == 4:
                self.enterOuterAlt(localctx, 4)
                self.state = 785
                self.match(DrakeParser.GT_EQ)
                pass

            elif la_ == 5:
                self.enterOuterAlt(localctx, 5)
                self.state = 786
                self.match(DrakeParser.LT_EQ)
                pass

            elif la_ == 6:
                self.enterOuterAlt(localctx, 6)
                self.state = 787
                self.match(DrakeParser.NOT_EQ_1)
                pass

            elif la_ == 7:
                self.enterOuterAlt(localctx, 7)
                self.state = 788
                self.match(DrakeParser.NOT_EQ_2)
                pass
    ...
    def term(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((((_la - 51)) & ~0x3f) == 0 and ((1 << (_la - 51)) & ((1 << (DrakeParser.STAR - 51)) | (1 << (DrakeParser.DIV - 51)) | (1 << (DrakeParser.MOD - 51)) | (1 << (DrakeParser.IDIV - 51)) | (1 << (DrakeParser.AT - 51)))) != 0):
                self.state = 841
                _la = self._input.LA(1)
                if not(((((_la - 51)) & ~0x3f) == 0 and ((1 << (_la - 51)) & ((1 << (DrakeParser.STAR - 51)) | (1 << (DrakeParser.DIV - 51)) | (1 << (DrakeParser.MOD - 51)) | (1 << (DrakeParser.IDIV - 51)) | (1 << (DrakeParser.AT - 51)))) != 0)):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
    ...
    def factor(self):
        ...
        try:
            ...
            if token in [DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP]:
                ...
                self.factor()
                pass
            elif token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.OPEN_BRACE]:
                self.enterOuterAlt(localctx, 2)
                self.state = 850
                self.power()
                pass
    ...
    class AtomContext(ParserRuleContext):
        ...
        def NUMBER(self):
            return self.getToken(DrakeParser.NUMBER, 0)
    ...
    def atom(self):
        ...
        try:
            ...
            if token in [DrakeParser.OPEN_PAREN]:
                ...
                self.match(DrakeParser.NAME)
                pass
            elif token in [DrakeParser.NUMBER]:
                self.state = 885
                self.match(DrakeParser.NUMBER)
                pass
                ...
                pass
            elif token in [DrakeParser.TRUE]:
                self.state = 893
                self.match(DrakeParser.TRUE)
                pass
            elif token in [DrakeParser.FALSE]:
                self.state = 894
                self.match(DrakeParser.FALSE)
                pass
            else:
                raise NoViableAltException(self)
    ...
    def exprlist(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [DrakeParser.STRING, DrakeParser.NUMBER, DrakeParser.NONE, DrakeParser.TRUE, DrakeParser.FALSE, DrakeParser.AWAIT, DrakeParser.NAME, DrakeParser.ELLIPSIS, DrakeParser.OPEN_PAREN, DrakeParser.OPEN_BRACK, DrakeParser.ADD, DrakeParser.MINUS, DrakeParser.NOT_OP, DrakeParser.OPEN_BRACE]:
                self.state = 958
                self.expr()
                pass
            elif token in [DrakeParser.STAR]:
    ...
    def yield_expr(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << DrakeParser.STRING) | (1 << DrakeParser.NUMBER) | (1 << DrakeParser.FROM) | (1 << DrakeParser.LAMBDA) | (1 << DrakeParser.NOT) | (1 << DrakeParser.NONE) | (1 << DrakeParser.TRUE) | (1 << DrakeParser.FALSE) | (1 << DrakeParser.AWAIT) | (1 << DrakeParser.NAME) | (1 << DrakeParser.ELLIPSIS) | (1 << DrakeParser.OPEN_PAREN) | (1 << DrakeParser.OPEN_BRACK))) != 0) or ((((_la - 66)) & ~0x3f) == 0 and ((1 << (_la - 66)) & ((1 << (DrakeParser.ADD - 66)) | (1 << (DrakeParser.MINUS - 66)) | (1 << (DrakeParser.NOT_OP - 66)) | (1 << (DrakeParser.OPEN_BRACE - 66)))) != 0):
                self.state = 1095
                self.yield_arg()
